...
class HighSchoolsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.high_school_read_endpoint = _Endpoint(
            settings={
                'response_type': (HighSchoolDetail,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/high_schools/{uuid}',
                'operation_id': 'high_school_read',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.high_schools_list_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedHighSchool,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/high_schools/',
                'operation_id': 'high_schools_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def high_school_read(
        self,
        uuid,
        **kwargs
    ):
        """high_school_read  # noqa: E501

        Return the detail of high scool  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.high_school_read(uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['uuid'] = \
            uuid
        return self.high_school_read_endpoint.call_with_http_info(**kwargs)

    def high_schools_list(
        self,
        **kwargs
    ):
        """high_schools_list  # noqa: E501

        Return a list of high schools with optional filtering.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.high_schools_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.high_schools_list_endpoint.call_with_http_info(**kwargs)
