...
class AcademicCalendarsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.academic_calendars_list_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedAcademicCalendars,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/academic_calendars/',
                'operation_id': 'academic_calendars_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def academic_calendars_list(
        self,
        **kwargs
    ):
        """academic_calendars_list  # noqa: E501

        Return a list of academic calendars with optional filtering.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.academic_calendars_list(async_req=True)
        >>> result = thread.get()
        ...
        return self.academic_calendars_list_endpoint.call_with_http_info(**kwargs)
