...
class UniversitiesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.universities_list_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedUniversity,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/universities/',
                'operation_id': 'universities_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.university_read_endpoint = _Endpoint(
            settings={
                'response_type': (UniversityDetail,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/universities/{uuid}',
                'operation_id': 'university_read',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def universities_list(
        ...
        **kwargs
        ...
        """universities_list  # noqa: E501

        Return a list of universities with optional filtering.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.universities_list(async_req=True)
        >>> result = thread.get()
        ...
        return self.universities_list_endpoint.call_with_http_info(**kwargs)
    ...
    def university_read(
        ...
        **kwargs
        ...
        """university_read  # noqa: E501

        Return the detail of university  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.university_read(uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['uuid'] = \
            uuid
        return self.university_read_endpoint.call_with_http_info(**kwargs)
