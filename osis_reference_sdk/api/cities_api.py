...
class CitiesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.cities_list_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedCity,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/cities/',
                'operation_id': 'cities_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def cities_list(
        ...
        **kwargs
        ...
        Return a list of cities with optional filtering.  # noqa: E501
        ...
        return self.cities_list_endpoint.call_with_http_info(**kwargs)
