...
class StudyDomainsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.study_domains_list_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedStudyDomain,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/study-domains',
                'operation_id': 'study_domains_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def study_domains_list(
        self,
        **kwargs
    ):
        """study_domains_list  # noqa: E501

        Return a list of study domains. By default, it will return all official main study domains.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.study_domains_list(async_req=True)
        >>> result = thread.get()
        ...
        return self.study_domains_list_endpoint.call_with_http_info(**kwargs)
