...
# **languages_list**
> ArrayOfLanguages languages_list()
...
with osis_reference_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.languages_list(limit=limit, offset=offset, search=search, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
...
[**ArrayOfLanguages**](ArrayOfLanguages.md)
